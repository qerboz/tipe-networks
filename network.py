...
class couche():
    def __init__(self,n,p):
        ...
        self.poids = 0.001 * np.random.random((n,p))
...
class reseauNeuronal():
    ...
    def calcul(self,entree):
        ...
        self.couches[0].neurones = entree #insertion des valeurs d'entree dans les premiers neurones
    ...
    def calcErr(self,valTheor):
        ...
        self.erreur = [self.dFoncAct(self.invFoncAct(valExp))*(valTheor-valExp)]
...
##Test
reconnaisseur = reseauNeuronal([75,42,20,6],1,sig)
